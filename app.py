...
with tab1:
    ...
    # LỆNH LƯU FILE ẢNH BIỂU ĐỒ 1
    fig1.write_image("bieu_do_1_hien_trang_su_dung.png", width=800, height=500)
...
with tab2:
    ...
    with col1:
        ...
        # LỆNH LƯU FILE ẢNH BIỂU ĐỒ 2
        fig2.write_image("bieu_do_2_nghich_ly_tu_dong.png", width=600, height=500)
    ...
    with col2:
        ...
        # LỆNH LƯU FILE ẢNH BIỂU ĐỒ 3
        fig3.write_image("bieu_do_3_ly_do_kiem_soat.png", width=600, height=500)
